...
interviews you (and reads whatever source material you point it at); the answers land here.
Everything else in the workspace traces back to it.*
...
*(Existing sources to seed from or bind to: folders, drives, apps, spreadsheets, emails.)*
